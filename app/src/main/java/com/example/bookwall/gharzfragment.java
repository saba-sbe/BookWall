...
public class gharzfragment extends Fragment {

    Button filter ,sort;
    RecyclerView recyclerView;
    public gharzfragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.gharz_fragment, container, false);
        return view;
    }
    ...
    private void findviews(View view) {
        filter = view.findViewById(R.id.gharz_filter);
        sort = view.findViewById(R.id.gharz_sort);
        recyclerView = view.findViewById(R.id.gharz_recycler_view);
    }
}
